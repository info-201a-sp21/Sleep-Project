...
```
  ...
  From the data by Michael Lomuscio who collected the data from students in international boarding school, our team founded that on average, students think that they get enough sleep when they slept `r summary_info[[1]]` hours. The average sleep hours for the phone-use group(the students who use the phone within 30 minutes of falling asleep) was `r summary_info[[2]]` hours, and the non-phone-use group(the students who do not use the phone before falling asleep) had `r summary_info[[3]]` hours for the average sleep hours. We could observe that both groups do not reach the ideal sleeping hours(`r summary_info[[1]]`) that students felt enough. With those two data points, we could also observe that the non-phone-use group slept less than the phone-use group. However, even though the phone-use group slept more than the non-phone-use group, only `r summary_info[[4]]`% of the phone-use group said that they are getting enough sleep while `r summary_info[[5]]`% of the non-phone-use group agreed with getting enough sleep. Even though the non-phone-use group slept less, they had a higher percentage of students who agreed with getting enough sleep. By these analyses, we noticed that phone usage before sleeping impacted students' perception of getting enough sleep. 
  
  Not only the phone usage but eating breakfast also impacted the students' sleep. The average sleep hour for the breakfast group(students who eat breakfast) was `r summary_info[[6]]` hours while the non-breakfast group(students who do not eat breakfast) had `r summary_info[[7]]` hours. `r summary_info[[8]]`% of the breakfast group agreed that they are having enough sleep while only `r summary_info[[9]]`% of the non-breakfast group agreed. The breakfast group seemed to have more percentage because they slept more than the non-breakfast group. However, the ratio of avg sleep hours between the two groups was `r summary_info[[10]]` (non-breakfast:breakfast), and the ratio of percent of students agreeing with getting enough sleep was `r summary_info[[11]]` (non-breakfast:breakfast). Since the ratio of students' enough rate is higher than the ratio of avg sleep hours, we can conclude that even though we considered the difference between their average sleep hours, still the breakfast group tends to have more students with enough sleep. The analysis from this dataset shows that the students' behaviors(phone usage and breakfast) are affecting the sleep quality rather than the hours of sleep.
